...
class Datatransformation:
    def __init__(self):
        self.data_tranformer_confic=DataTransformationconfig()
    ...
    def initiate_data_tranformation(self,train_path,test_path):
        try:
            ...
            logging.info('applying preprocession object on tranning dataframe and testing dataframe')
            ...
            save_object(
               file_path = self.data_tranformer_confic.preprocessing_obj_file_path,
            ...
            return (
                train_arr,
                test_arr,
                self.data_tranformer_confic.preprocessing_obj_file_path
            )
        except Exception as e:
           raise CustomException(e,sys)